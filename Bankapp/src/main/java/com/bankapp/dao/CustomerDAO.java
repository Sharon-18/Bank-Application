...
public class CustomerDAO {
    ...
    public void addCustomer(Customer customer) throws SQLException {
        ...
        try (Connection conn = DatabaseConnection.getConnection();
            ...
            stmt.setString(10, PasswordUtils.hashPassword(customer.getPassword()));
            stmt.executeUpdate();
        }
    }
    ...
    public void deleteCustomer(int customerId) throws SQLException {
        ...
        try (Connection conn = DatabaseConnection.getConnection(); // Assumes DatabaseConnection is a utility class for getting connections
             PreparedStatement stmt = conn.prepareStatement(query)) {
    ...
    public void updateCustomerPassword(String accountNo, String newPassword) throws SQLException {
